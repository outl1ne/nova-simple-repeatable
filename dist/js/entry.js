...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    createRows: function createRows() {
      var _this2 = this;
      this.rows = this.currentField.rows.map(function (row, rowIndex) {
        return _this2.copyFields(row.fields, rowIndex);
      });
    },
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  computed: {
    ...
    resultCountLabel: function resultCountLabel() {
      ...
      return this.currentPageCount && "".concat(Nova.formatNumber(first + 1), "-").concat(Nova.formatNumber(first + this.currentPageCount), " ").concat(this.__('of'), " ").concat(Nova.formatNumber(this.totalPages));
    }
  }
});
