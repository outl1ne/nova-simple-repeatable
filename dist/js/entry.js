...
/* harmony export */ });
/* harmony import */ var _mixins_HandlesRepeatable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../mixins/HandlesRepeatable */ "./resources/js/mixins/HandlesRepeatable.js");

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  props: ['index', 'resource', 'resourceName', 'resourceId', 'field'],
  mixins: [_mixins_HandlesRepeatable__WEBPACK_IMPORTED_MODULE_0__["default"]],
  computed: {
    ...
    headers: function headers() {
      ...
      return rows && rows[0] && rows[0].fields.map(function (field) {
        return {
          name: field.name,
  ...
  methods: {
    handleValue: function handleValue(valuesArray) {
      ...
      if (fieldsWithOptions.length > 0) {
        fieldsWithOptions.forEach(function (field) {
          valuesArray = valuesArray.map(function (entry) {
            var id = entry[field.attribute];
            if (!!id) {
              // Try the usual label-value pair
              if (field.options[0].value && field.options[0].label) {
                // Yay, we recognize this format
                var optionMatch = field.options.find(function (o) {
    ...
    sortValueByHeaders: function sortValueByHeaders(valuesArray) {
...
/* harmony import */ var laravel_nova__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! laravel-nova */ "./vendor/laravel/nova/resources/js/mixins/packages.js");
/* harmony import */ var _mixins_HandlesRepeatable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../mixins/HandlesRepeatable */ "./resources/js/mixins/HandlesRepeatable.js");
/* harmony import */ var _mixins_PaginateRepeatable__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../mixins/PaginateRepeatable */ "./resources/js/mixins/PaginateRepeatable.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  mixins: [laravel_nova__WEBPACK_IMPORTED_MODULE_2__.FormField, laravel_nova__WEBPACK_IMPORTED_MODULE_2__.HandlesValidationErrors, laravel_nova__WEBPACK_IMPORTED_MODULE_2__.DependentFormField, _mixins_HandlesRepeatable__WEBPACK_IMPORTED_MODULE_3__["default"], _mixins_PaginateRepeatable__WEBPACK_IMPORTED_MODULE_4__["default"]],
  components: {
  ...
  methods: {
    fill: function fill(formData) {
      var ARR_REGEX = function ARR_REGEX() {
        return /\[\d+\]$/g;
      };
      var allValues = [];
        ...
        var _loop = function _loop() {
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              ...
              var isArray = !!key.match(ARR_REGEX());
              if (isArray) {
                var result = ARR_REGEX().exec(key);
                key = "".concat(key.slice(0, result.index)).concat(key.slice(result.index + result[0].length));
              }
              try {
              ...
              if (isArray) {
                ...
                lodash_set__WEBPACK_IMPORTED_MODULE_5___default()(rowValues, key, normalizedValue);
              }
            }
          } catch (err) {
            _iterator2.e(err);
  ...
  computed: {
    extraAttributes: function extraAttributes() {
      var attrs = this.currentField.extraAttributes;
      return _objectSpread({}, attrs);
    },
    repeatableValidation: function repeatableValidation() {
      var fields = this.fields;
      var errors = this.errors.errors;
      var repeaterAttr = this.field.attribute;
      var safeRepeaterAttr = this.field.attribute.replace(/.{16}__/, '');
      var erroredFieldLocales = {};
      var formattedKeyErrors = {};
      ...
      try {
        var _loop2 = function _loop2() {
          ...
          var fieldAttr = field.originalAttribute;

          // Find all errors related to this field
          var relatedErrors = Object.keys(errors).filter(function (err) {
            return !!err.match(new RegExp("^".concat(safeRepeaterAttr, ".\\d+.").concat(fieldAttr)));
          });
          var isTranslatable = field.component === 'translatable-field';
          if (isTranslatable) {
            var foundLocales = relatedErrors.map(function (errorKey) {
              return errorKey.split('.').slice(-1);
            }).flat();
            erroredFieldLocales[fieldAttr] = foundLocales;
          }

          // Format field
          relatedErrors.forEach(function (errorKey) {
            var rowIndex = errorKey.split('.')[1];
            var uniqueKey = "".concat(repeaterAttr, "---").concat(field.originalAttribute, "---").concat(rowIndex);
            if (isTranslatable) {
              var locale = errorKey.split('.').slice(-1)[0];
              uniqueKey = "".concat(uniqueKey, ".").concat(locale);
            }
      ...
      return {
        errors: new form_backend_validation__WEBPACK_IMPORTED_MODULE_1__.Errors(formattedKeyErrors),
    ...
    canDeleteRows: function canDeleteRows() {
...
var _hoisted_2 = {
  "class": "nsr-table nsr-w-full nsr-table-default nova-resource-table"
};
var _hoisted_3 = {
  "class": "nsr-border-b nsr-border-slate-200 dark:nsr-border-slate-600"
};
var _hoisted_4 = {
  key: 1
};
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_PanelItem, {
    ...
    value: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [$options.values && $options.values.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("table", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("thead", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tr", _hoisted_3, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.headers, function (header, i) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("th", {
          key: i
        }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(header.name), 1 /* TEXT */);
      }), 128 /* KEYED_FRAGMENT */))])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tbody", null, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($props.field.rows, function (row, i) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("tr", {
        ...
        }, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(row.fields, function (rowField, j) {
          return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("td", {
            ...
            key: j
          }, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)((0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveDynamicComponent)("detail-".concat(rowField.component)), {
            key: j,
            field: rowField,
            "class": "nsr-mr-3",
            "unique-id": _ctx.getUniqueId($props.field, rowField)
          }, null, 8 /* PROPS */, ["field", "unique-id"]))]);
        }), 128 /* KEYED_FRAGMENT */))]);
      }), 128 /* KEYED_FRAGMENT */))])])])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_4, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.value && _ctx.value.label || '—'), 1 /* TEXT */))];
    }),
...
var _hoisted_1 = {
  key: 0,
  "class": "nsr-w-full nsr-flex nsr-border-b nsr-py-2 dark:nsr-border-slate-600"
};
var _hoisted_2 = {
  "class": "simple-repeatable-row nsr-flex nsr-py-3 nsr-pl-3 nsr-relative nsr-rounded-md"
};
var _hoisted_3 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
  "class": "vue-draggable-handle nsr-flex nsr-justify-center nsr-items-center nsr-cursor-pointer"
...
var _hoisted_4 = {
  "class": "simple-repeatable-fields-wrapper nsr-w-full nsr-flex"
};
...
var _hoisted_8 = {
  "class": "text-xs px-4 ml-auto"
};
function render(_ctx, _cache, $props, $setup, $data, $options) {
  var _component_nova_translatable_locale_tabs = (0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveComponent)("nova-translatable-locale-tabs");
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultField, {
    ...
    field: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", (0,vue__WEBPACK_IMPORTED_MODULE_0__.mergeProps)({
        "class": "flex flex-col"
      }, $options.extraAttributes), [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Title columns "), _ctx.rows.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(_ctx.fields, function (rowField, i) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
          key: i,
          "class": "nsr-font-bold nsr-text-90 nsr-text-md nsr-w-full nsr-ml-3 nsr-flex"
        }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(rowField.name), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("  If field is nova-translatable, render seperate locale-tabs   "), rowField.component === 'translatable-field' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_nova_translatable_locale_tabs, {
          key: 0,
          style: {
            "padding": "0"
          },
          ...
          "active-locale": _ctx.activeLocales[i] || rowField.formattedLocales[0].key,
          "locales-with-errors": $options.repeatableValidation.locales[rowField.originalAttribute],
          onTabClick: function onTabClick(locale) {
            return _ctx.setAllLocales("sr-".concat($props.field.attribute, "-").concat(rowField.originalAttribute), locale);
          },
          onDoubleClick: _cache[0] || (_cache[0] = function (locale) {
            return _ctx.setAllLocales(void 0, locale);
          })
        }, null, 8 /* PROPS */, ["locales", "display-type", "active-locale", "locales-with-errors", "onTabClick"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]);
      }), 128 /* KEYED_FRAGMENT */))])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_draggable, {
        modelValue: _ctx.rows,
        "onUpdate:modelValue": _cache[1] || (_cache[1] = function ($event) {
          return _ctx.rows = $event;
        }),
        "item-key": function itemKey(el, i) {
          return el && el[0] && el[0].attribute || i;
        },
        ...
        item: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function (_ref) {
          var element = _ref.element,
            index = _ref.index;
          return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [_hoisted_3, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(element, function (rowField, j) {
            return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)((0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveDynamicComponent)("form-".concat(rowField.component)), {
              key: j,
              field: rowField,
              errors: $options.repeatableValidation.errors,
              "unique-id": _ctx.getUniqueId($props.field, rowField),
              "class": "nsr-mr-3"
            }, null, 8 /* PROPS */, ["field", "errors", "unique-id"]);
          }), 128 /* KEYED_FRAGMENT */))]), $options.canDeleteRows ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
            key: 0,
        ...
        _: 1 /* STABLE */
      }, 8 /* PROPS */, ["modelValue", "item-key"]), $options.canAddRows ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultButton, {
        key: 1,
        onClick: $options.addRow,
        "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["add-button btn btn-default btn-primary", {
          'delete-width': $options.canDeleteRows,
          'mt-3': _ctx.rows.length
        }]),
        type: "button"
      }, {
        "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($props.field.addRowLabel), 1 /* TEXT */)];
        }),

        _: 1 /* STABLE */
      }, 8 /* PROPS */, ["onClick", "class"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 16 /* FULL_PROPS */), _ctx.isPaginated ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)((0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveDynamicComponent)("pagination-links"), {
        key: 0,
        "class": "dark:nsr-border-slate-600 rounded-lg nsr-border",
        onPage: $options.selectPage,
        pages: _ctx.totalPages,
        page: _ctx.currentPage
      }, {
        "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_8, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(_ctx.resultCountLabel), 1 /* TEXT */)];
        }),

        _: 1 /* STABLE */
      }, 40 /* PROPS, HYDRATE_EVENTS */, ["onPage", "pages", "page"])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)];
    }),
    _: 1 /* STABLE */
...
var simpleRepeatableDarkModeObserver = null;
Nova.booting(function (Vue, store) {
  simpleRepeatableDarkModeObserver = new MutationObserver(function () {
  ...
  Vue.component('detail-simple-repeatable', _components_DetailField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  Vue.component('form-simple-repeatable', _components_FormField__WEBPACK_IMPORTED_MODULE_1__["default"]);
});

/***/ }),

/***/ "./resources/js/mixins/HandlesRepeatable.js":
/*!**************************************************!*\
  !*** ./resources/js/mixins/HandlesRepeatable.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    (this.field.fields || []).forEach(function (field, i) {
      if (field.component !== 'translatable-field') return;
      _this.activeLocales[i] = void 0;
      var id = field.component === 'translatable-field' ? "sr-".concat(_this.field.attribute, "-").concat(field.attribute) : void 0;
      var eventName = _this.getAllLocalesEventName(id);
      Nova.$on(eventName, function (locale) {
        _this.activeLocales = _objectSpread(_objectSpread({}, _this.activeLocaqules), {}, _defineProperty({}, i, locale));
      });
      Nova.$on(_this.getAllLocalesEventName(void 0), function (locale) {
        _this.activeLocales = _objectSpread(_objectSpread({}, _this.activeLocales), {}, _defineProperty({}, i, locale));
      });
    });
  },
  methods: {
    ...
    createRows: function createRows() {
      var _this2 = this;
      this.rows = this.currentField.rows.map(function (row, idx) {
        var index = _this2.currentPage > 1 ? idx + _this2.perPage * (_this2.currentPage - 1) : idx;
        return _this2.copyFields(row.fields, index);
      });
    },
    setInitialValue: function setInitialValue() {
      // Initialize minimum amount of rows
      if (this.currentField.minRows && !isNaN(this.currentField.minRows)) {
        while (this.rows.length < this.currentField.minRows) {
          this.addRow();
        }
      }
    },
    copyFields: function copyFields(fields) {
      var _this3 = this;
      var rowIndex = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : void 0;
      if (!rowIndex) rowIndex = this.rows.length;

      // Return an array of fields with unique attribute
      return fields.map(function (field) {
        var uniqueAttribute = "".concat(_this3.field.attribute, "---").concat(field.attribute, "---").concat(rowIndex);
        var formattedLocales = null;
        if (field.component === 'translatable-field') {
          formattedLocales = _this3.getFieldLocales(field);
        }
    ...
    getFieldLocales: function getFieldLocales(field) {
      var localeKeys = Object.keys(field.translatable.locales);
      ...
      return localeKeys.map(function (key) {
        return {
          key: key,
          name: field.translatable.locales[key]
        };
      });
    },
    setAllLocales: function setAllLocales(uniqueId, newLocale) {
    ...
    getAllLocalesEventName: function getAllLocalesEventName(uniqueId) {
    ...
    getUniqueId: function getUniqueId(field, rowField) {
      var rAttribute = rowField.originalAttribute || rowField.attribute;
      return rowField.component === 'translatable-field' ? "sr-".concat(field.attribute, "-").concat(rAttribute) : void 0;
    }
  },
  computed: {
    fields: function fields() {
      return (this.rows[0] || []).filter(function (field) {
        return field.component !== 'hidden-field';
      });
    }
  }
});
...
/***/ "./resources/js/mixins/PaginateRepeatable.js":
/*!***************************************************!*\
  !*** ./resources/js/mixins/PaginateRepeatable.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  computed: {
    ...
    resultCountLabel: function resultCountLabel() {
      ...
      var from = Nova.formatNumber(first + 1);
      var to = Nova.formatNumber(first + this.currentPageCount);
      var total = Nova.formatNumber(this.currentField.totalCount);
      return "".concat(from, "-").concat(to, " ").concat(this.__('of'), " ").concat(total);
    }
  }
});
    ...
    if (!lodash_isEmpty__WEBPACK_IMPORTED_MODULE_5___default()(this.dependsOn)) {
      lodash_forIn__WEBPACK_IMPORTED_MODULE_2___default()(this.dependsOn, function (defaultValue, dependsOn) {
        _this.watchedEvents[dependsOn] = function (value) {
          console.log('nova event emitted');
        ...
        console.log('depends on test', dependsOn);
        console.log(_this.getFieldAttributeChangeEventName(dependsOn));
  ...
  methods: {
    ...
    syncField: function syncField() {
      ...
      Nova.request().patch(this.syncEndpoint || this.syncFieldEndpoint, this.dependentFieldValues, {
        ...
        console.log('sync field finished');
        ...
        console.log('calling on syncedField');
...
/* harmony import */ var form_backend_validation__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! form-backend-validation */ "./node_modules/form-backend-validation/dist/index.js");
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".simple-repeatable.detail-field .simple-repeatable-detail-field-wrapper > *,\n.simple-repeatable.detail-field .simple-repeatable-detail-field-wrapper .translatable-field > div:not(:first-child) div {\n  flex: 1;\n  flex-shrink: 0;\n  min-width: 0;\n  border: none !important;\n}\n.simple-repeatable.detail-field .simple-repeatable-detail-field-wrapper > * > *:nth-child(1):not(:only-child),\n.simple-repeatable.detail-field .simple-repeatable-detail-field-wrapper .translatable-field > div:not(:first-child) div > *:nth-child(1):not(:only-child) {\n  display: none;\n}\n.simple-repeatable.detail-field .simple-repeatable-detail-field-wrapper > * > *:only-child > *:nth-child(1):not(:only-child),\n.simple-repeatable.detail-field .simple-repeatable-detail-field-wrapper .translatable-field > div:not(:first-child) div > *:only-child > *:nth-child(1):not(:only-child) {\n  display: none;\n}\n.simple-repeatable.detail-field .simple-repeatable-detail-field-wrapper > * > *:only-child > :nth-child(2),\n.simple-repeatable.detail-field .simple-repeatable-detail-field-wrapper .translatable-field > div:not(:first-child) div > *:only-child > :nth-child(2) {\n  width: 100% !important;\n  padding: 0 !important;\n}\n.simple-repeatable.detail-field .simple-repeatable-detail-field-wrapper > * .compact-nova-field-wrapper,\n.simple-repeatable.detail-field .simple-repeatable-detail-field-wrapper .translatable-field > div:not(:first-child) div .compact-nova-field-wrapper {\n  padding: 0 !important;\n}\n.simple-repeatable.detail-field .simple-repeatable-detail-field-wrapper > * > :nth-child(2),\n.simple-repeatable.detail-field .simple-repeatable-detail-field-wrapper .translatable-field > div:not(:first-child) div > :nth-child(2) {\n  width: 100% !important;\n  padding: 0 !important;\n}\n.simple-repeatable.detail-field .simple-repeatable-table-row td {\n  padding: 4px 8px;\n}", ""]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".simple-repeatable.form-field .simple-repeatable-row {\n  width: calc(100% + 68px);\n  margin-left: -46px;\n}\n.simple-repeatable.form-field .simple-repeatable-row > .simple-repeatable-fields-wrapper .translatable-field {\n  padding-top: 0 !important;\n}\n.simple-repeatable.form-field .simple-repeatable-row > .simple-repeatable-fields-wrapper > *,\n.simple-repeatable.form-field .simple-repeatable-row > .simple-repeatable-fields-wrapper .translatable-field > div:not(:first-child) > div {\n  flex: 1;\n  flex-shrink: 0;\n  min-width: 0;\n  border: none !important;\n}\n.simple-repeatable.form-field .simple-repeatable-row > .simple-repeatable-fields-wrapper > * > *:nth-child(1):not(:only-child),\n.simple-repeatable.form-field .simple-repeatable-row > .simple-repeatable-fields-wrapper .translatable-field > div:not(:first-child) > div > *:nth-child(1):not(:only-child) {\n  display: none;\n}\n.simple-repeatable.form-field .simple-repeatable-row > .simple-repeatable-fields-wrapper > * > *:only-child > *:nth-child(1):not(:only-child),\n.simple-repeatable.form-field .simple-repeatable-row > .simple-repeatable-fields-wrapper .translatable-field > div:not(:first-child) > div > *:only-child > *:nth-child(1):not(:only-child) {\n  display: none;\n}\n.simple-repeatable.form-field .simple-repeatable-row > .simple-repeatable-fields-wrapper > * > *:only-child > :nth-child(2),\n.simple-repeatable.form-field .simple-repeatable-row > .simple-repeatable-fields-wrapper .translatable-field > div:not(:first-child) > div > *:only-child > :nth-child(2) {\n  width: 100% !important;\n  padding: 0 !important;\n}\n.simple-repeatable.form-field .simple-repeatable-row > .simple-repeatable-fields-wrapper > * .compact-nova-field-wrapper,\n.simple-repeatable.form-field .simple-repeatable-row > .simple-repeatable-fields-wrapper .translatable-field > div:not(:first-child) > div .compact-nova-field-wrapper {\n  padding: 0 !important;\n}\n.simple-repeatable.form-field .simple-repeatable-row > .simple-repeatable-fields-wrapper > * > :nth-child(2),\n.simple-repeatable.form-field .simple-repeatable-row > .simple-repeatable-fields-wrapper .translatable-field > div:not(:first-child) > div > :nth-child(2) {\n  width: 100% !important;\n  padding: 0 !important;\n}\n.simple-repeatable.form-field .simple-repeatable-row .delete-icon {\n  width: 36px;\n  height: 36px;\n  margin-right: 10px;\n}\n.simple-repeatable.form-field .simple-repeatable-row .vue-draggable-handle {\n  height: 36px;\n  width: 36px;\n  margin-right: 10px;\n}\n.simple-repeatable.form-field .simple-repeatable-row .vue-draggable-handle:hover {\n  opacity: 0.8;\n}\n.simple-repeatable.form-field .simple-repeatable-row:hover {\n  background: var(--40);\n}\n.simple-repeatable.form-field .add-button {\n  width: calc(100% + 11px);\n}\n.simple-repeatable.form-field .add-button.delete-width {\n  width: calc(100% - 22px);\n}\n.simple-repeatable.form-field > :nth-child(1) {\n  min-width: 20%;\n}\n.simple-repeatable.form-field > :nth-child(2) {\n  width: 100% !important;\n  margin-right: 24px;\n}\n.simple-repeatable.form-field > *:only-child > *:nth-child(1) {\n  min-width: 20%;\n}\n.simple-repeatable.form-field > *:only-child > *:nth-child(2) {\n  width: 100% !important;\n  margin-right: 24px;\n}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_use_3_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_DetailField_vue_vue_type_style_index_0_id_0224618e_lang_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!../../../node_modules/vue-loader/dist/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./DetailField.vue?vue&type=style&index=0&id=0224618e&lang=scss */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/DetailField.vue?vue&type=style&index=0&id=0224618e&lang=scss");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_use_3_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_DetailField_vue_vue_type_style_index_0_id_0224618e_lang_scss__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony import */ var _DetailField_vue_vue_type_style_index_0_id_0224618e_lang_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DetailField.vue?vue&type=style&index=0&id=0224618e&lang=scss */ "./resources/js/components/DetailField.vue?vue&type=style&index=0&id=0224618e&lang=scss");
/* harmony import */ var _Users_kaspar_code_lib_nova_simple_repeatable_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
/***/ "./resources/js/components/DetailField.vue?vue&type=style&index=0&id=0224618e&lang=scss":
/*!**********************************************************************************************!*\
  !*** ./resources/js/components/DetailField.vue?vue&type=style&index=0&id=0224618e&lang=scss ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_use_1_node_modules_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_use_2_node_modules_sass_loader_dist_cjs_js_clonedRuleSet_12_use_3_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_DetailField_vue_vue_type_style_index_0_id_0224618e_lang_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/style-loader/dist/cjs.js!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!../../../node_modules/vue-loader/dist/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!../../../node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./DetailField.vue?vue&type=style&index=0&id=0224618e&lang=scss */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-12.use[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/DetailField.vue?vue&type=style&index=0&id=0224618e&lang=scss");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkoutl1ne_nova_simple_repeatable"] = self["webpackChunkoutl1ne_nova_simple_repeatable"] || [];
